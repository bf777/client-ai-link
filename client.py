"""
@nuttwerx's AI GRPC client,
from https://github.com/nuttwerx/ai-grpc-client/blob/master/client.py.
"""
import sys
sys.path.append('/Users/bfory/Desktop/rloop/src/rloop/Go-Ground-Station/proto/python_proto')
...
def apply_values(values):
    output = brain.update(100, values)
    print(output)
